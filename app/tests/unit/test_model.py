...
class TestModel(unittest.TestCase):
    ...
    journal_journal_path = "%s/ignition_journal" % unit_path
    engine = None
    ...
    # @unittest.skip("")
    def test_00(self):
        i = crud.Inject(self.engine, self.journal_journal_path, posts.M01)
        i.commit_and_close()
        fetch = crud.Fetch(self.engine, self.journal_journal_path)
    ...
    def test_01(self):
        i = crud.Inject(self.engine, self.journal_journal_path,  posts.M02)
        i.commit_and_close()
        fetch = crud.Fetch(self.engine, self.journal_journal_path)
        interfaces = fetch.get_all_interfaces()
    ...
    def test_02(self):
        m1 = crud.Inject(self.engine, self.journal_journal_path,  posts.M01)
        m1.commit_and_close()
        i = crud.Inject(self.engine, self.journal_journal_path,   posts.M02)
        i.commit_and_close()
        i = crud.Inject(self.engine, self.journal_journal_path,   posts.M02)
    ...
    def test_03(self):
        i = crud.Inject(self.engine, self.journal_journal_path, posts.M03)
        i.commit_and_close()
        fetch = crud.Fetch(self.engine, self.journal_journal_path)
        interfaces = fetch.get_all_interfaces()
    ...
    def test_04(self):
        for p in posts.ALL:
            i = crud.Inject(self.engine, self.journal_journal_path,  p)
            i.commit_and_close()
        fetch = crud.Fetch(self.engine, self.journal_journal_path)
        interfaces = fetch.get_all_interfaces()
    ...
    def test_06(self):
        i = crud.Inject(self.engine, self.journal_journal_path,  posts.M16)
        i.commit_and_close()

    def test_07(self):
        with self.assertRaises(KeyError):
            i = crud.Inject(self.engine, self.journal_journal_path,  {
                u'boot-info': {},
                u'lldp': {},
                u'interfaces': []
            })
